/**
 * @description Information messages [100-199]
 */
const Information = {
  /**
   * @description
...
/**
 * @description Successful Responses [200-299]
 */
const Successful = {
  /**
   * @description
   ...
   */
  AlreadyReported_WebDAV_: 208,

  /**
   * @description
   * The server has fulfilled a GET request for the resource, and the response is a representation of the result of one or more instance-manipulations applied to the current instance.
   */
  IMUsed_HTTPDeltaEncoding_: 226,
};

/**
 * @description Redirection Messages [300-399]
 */
const Redirection = {
  /**
   * @description
...
/**
 * @description Client Error Responses [400-499]
 */
const ClientError = {
  /**
   * @description
...
/**
 * @description Server Error Responses [500-599]
 */
const ServerError = {
  /**
   * @description
